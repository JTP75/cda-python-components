...
class ConfigUtil(metaclass = Singleton):
    ...
    def getUseEmulator(self) -> bool:
        """
        Returns true if the env variable SENSE_HAT_EMULATE is true 
        or doesn't exist, and returns false if SENSE_HAT_EMULATE is
        false.
        
        @return False if 'SENSE_HAT_EMULATE' is false; True otherwise.
        """
        return os.getenv('SENSE_HAT_EMULATE', 'true').lower() in ['true', '1', 'yes', 'y']
