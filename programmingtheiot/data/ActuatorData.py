...
class ActuatorData(BaseIotData):
    ...
    def __str__(self):
        return f"ActuatorData(name={self.name}, typeID={self.typeID}, command={self.command}, value={self.value}, stateData={self.stateData}, isResponse={self.isResponse}, timeStamp={self.timeStamp})"
    ...
    def _handleUpdateData(self, data: "ActuatorData"):
